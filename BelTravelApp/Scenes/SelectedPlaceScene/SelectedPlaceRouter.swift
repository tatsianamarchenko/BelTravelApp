...
class SelectedPlaceRouter: NSObject, SelectedPlaceRoutingLogic, SelectedPlaceDataPassing
{
  ...
  //func navigateToSomewhere(source: SelectedPlaceViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: SelectedPlaceDataStore, destination: inout SomewhereDataStore)
  //{
